...
class CardinalDirections {
    ...
    public func cardinalDirection (forHeading heading:Double) -> String {
        switch heading {
        case 0 ..< 45:
            return "N"
        case 45 ..< 135:
    ...
    ///ex: NW, SE (8 possible)
    public func intercardinalDirection (forHeading heading:Double) -> String {
        switch heading {
        case 0 ..< 22.5:
            return "N"
        case 22.5 ..< 67.5:
    ...
    public func secIntercardinalDirection (forHeading heading:Double) -> String {
        switch heading {
        case 0 ..< 11.25:
            return "N"
        case 11.25 ..< 33.75:
